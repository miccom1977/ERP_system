                            ...
                            @else
                                <form method="post" action="{{ route('product.update', $product->id ) }}">
                                    ...
                                    <table width="100%">
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" name="description" id="description" value="{{ $product->description }}" readonly>
                                            </td>
                                            <td>
                                                <input type="number" class="w-20" name="grammage" id="grammage" value="{{ $product->grammage }}" readonly>
                                            </td>
                                            <td>
                                                <input type="number" class="w-20" name="roll_width" id="roll_width" value="{{ $product->roll_width }}" readonly>
                                            </td>
                                            <td>
                                                <select name="designation" class="w-22" id="designation" onchange="this.value = '{{ $product->designation }}' ">
                                                    <option value="PP" {{ $product->designation == "PP" ? 'selected' : '' }}>PP</option>
                                                    <option value="GK/MGK" {{ $product->designation == "GK/MGK" ? 'selected' : '' }}>GK/MGK</option>
                                                    <option value="PET" {{ $product->designation == "PET" ? 'selected' : '' }}>PET</option>
                                                    <option value="FOOD" {{ $product->designation == "FOOD" ? 'selected' : '' }}>FOOD</option>
                                            ...
                                            <td>
                                                <select name="cardboard_producer" id="cardboard_producer"  onchange="this.value = '{{ $product->cardboard_producer }}' ">
                                                    <option value="Maro-Pack" {{ $product->cardboard_producer == "Maro-Pack" ? 'selected' : '' }}>Maro-Pack</option>
                                                    <option value="Jade-Pack" {{ $product->cardboard_producer == "Jade-Pack" ? 'selected' : '' }}>Jade-Pack</option>
                                                    <option value="Albertin" {{ $product->cardboard_producer == "Albertin" ? 'selected' : '' }}>Albertin</option>
                                                    <option value="DS-Smith" {{ $product->cardboard_producer == "DS-Smith" ? 'selected' : '' }}>DS-Smith</option>
